...
interface DBConstants {
	static final String TABLE_EVENT_SOURCE = "EVENT_SOURCE";
	static final String TABLE_EVENT_SOURCE_PROPERTY = "EVENT_SOURCE_PROPERTY";
	static final String TABLE_DASHBOARD = "DASHBOARD";
	static final String TABLE_WIDGET = "WIDGET";
	static final String TABLE_WIDGET_DATA = "WIDGET_DATA";
	static final String TABLE_VALUES = "OVERSIGT_PROPERTY";

	static final ColumnOptions[] COLUMN_OPTIONS_EVENT_SOURCE = new ColumnOptions[] {
	...
	static final ColumnOptions[] COLUMN_OPTIONS_EVENT_SOURCE_PROPERTY = new ColumnOptions[] {
	...
	static final ColumnOptions[] COLUMN_OPTIONS_DASHBOARD = new ColumnOptions[] {
			new ColumnOptions("ID", ColumnType.Text, null, false, true),
			...
			new ColumnOptions("ENABLED", ColumnType.Boolean, true, false, false),
			new ColumnOptions("LAST_CHANGE", ColumnType.Timestamp, null, false, false) };
	static final ColumnOptions[] COLUMN_OPTIONS_WIDGET = new ColumnOptions[] {
			...
			new ColumnOptions("LAST_CHANGE", ColumnType.Timestamp, null, false, false) };
	static final ColumnOptions[] COLUMN_OPTIONS_WIDGET_DATA = new ColumnOptions[] {
			new ColumnOptions("WIDGET_ID", ColumnType.Integer, null, false, true),
			new ColumnOptions("NAME", ColumnType.Text, null, false, true),
			new ColumnOptions("VALUE", ColumnType.Text, null, false, false) };
	static final ColumnOptions[] COLUMN_OPTIONS_VALUES = new ColumnOptions[] {
	...
	String[] COLUMNS_EVENT_SOURCE_PROPERTY = Stream.of(COLUMN_OPTIONS_EVENT_SOURCE_PROPERTY)
			...
			.collect(toList())
			.toArray(new String[0]);
	String[] COLUMNS_DASHBOARD = Stream.of(COLUMN_OPTIONS_DASHBOARD)
			.map(ColumnOptions::getName)
			.collect(toList())
			.toArray(new String[0]);
	String[] COLUMNS_WIDGET = Stream.of(COLUMN_OPTIONS_WIDGET).map(ColumnOptions::getName).collect(toList()).toArray(
			new String[0]);
	String[] COLUMNS_WIDGET_DATA = Stream.of(COLUMN_OPTIONS_WIDGET_DATA)
			.map(ColumnOptions::getName)
			.collect(toList())
			.toArray(new String[0]);
	String[] COLUMNS_VALUES = Stream.of(COLUMN_OPTIONS_VALUES).map(ColumnOptions::getName).collect(toList()).toArray(
			new String[0]);
}
