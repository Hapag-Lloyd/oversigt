...
public class Color {
	private static final Map<String, Color> CSS_COLORS
			= Maps.builder(new TreeMap<String, Color>(String.CASE_INSENSITIVE_ORDER))
					.put("AliceBlue", parse("#F0F8FF"))
					.put("AntiqueWhite", parse("#FAEBD7"))
					.put("Aqua", parse("#00FFFF"))
					.put("AquaMarine", parse("#7FFFD4"))
					.put("Azure", parse("#F0FFFF"))
					.put("Beige", parse("#F5F5DC"))
					.put("Bisque", parse("#FFE4C4"))
					.put("Black", parse("#000000"))
					.put("BlanchedAlmond", parse("#FFEBCD"))
					.put("Blue", parse("#0000FF"))
					.put("BlueViolet", parse("#8A2BE2"))
					.put("Brown", parse("#A52A2A"))
					.put("BurlyWood", parse("#DEB887"))
					.put("CadetBlue", parse("#5F9EA0"))
					.put("Chartreuse", parse("#7FFF00"))
					.put("Chocolate", parse("#D2691E"))
					.put("Coral", parse("#FF7F50"))
					.put("CornflowerBlue", parse("#6495ED"))
					.put("Cornsilk", parse("#FFF8DC"))
					.put("Crimson", parse("#DC143C"))
					.put("Cyan", parse("#00FFFF"))
					.put("DarkBlue", parse("#00008B"))
					.put("DarkCyan", parse("#008B8B"))
					.put("DarkGoldenRod", parse("#B8860B"))
					.put("DarkGray", parse("#A9A9A9"))
					.put("DarkGrey", parse("#A9A9A9"))
					.put("DarkGreen", parse("#006400"))
					.put("DarkKhaki", parse("#BDB76B"))
					.put("DarkMagenta", parse("#8B008B"))
					.put("DarkOliveGreen", parse("#556B2F"))
					.put("DarkOrange", parse("#FF8C00"))
					.put("DarkOrchid", parse("#9932CC"))
					.put("DarkRed", parse("#8B0000"))
					.put("DarkSalmon", parse("#E9967A"))
					.put("DarkSeaGreen", parse("#8FBC8F"))
					.put("DarkSlateBlue", parse("#483D8B"))
					.put("DarkSlateGray", parse("#2F4F4F"))
					.put("DarkSlateGrey", parse("#2F4F4F"))
					.put("DarkTurquoise", parse("#00CED1"))
					.put("DarkViolet", parse("#9400D3"))
					.put("DeepPink", parse("#FF1493"))
					.put("DeepSkyBlue", parse("#00BFFF"))
					.put("DimGray", parse("#696969"))
					.put("DimGrey", parse("#696969"))
					.put("DodgerBlue", parse("#1E90FF"))
					.put("FireBrick", parse("#B22222"))
					.put("FloralWhite", parse("#FFFAF0"))
					.put("ForestGreen", parse("#228B22"))
					.put("Fuchsia", parse("#FF00FF"))
					.put("Gainsboro", parse("#DCDCDC"))
					.put("GhostWhite", parse("#F8F8FF"))
					.put("Gold", parse("#FFD700"))
					.put("GoldenRod", parse("#DAA520"))
					.put("Gray", parse("#808080"))
					.put("Grey", parse("#808080"))
					.put("Green", parse("#008000"))
					.put("GreenYellow", parse("#ADFF2F"))
					.put("HoneyDew", parse("#F0FFF0"))
					.put("HotPink", parse("#FF69B4"))
					.put("IndianRed", parse("#CD5C5C"))
					.put("Indigo", parse("#4B0082"))
					.put("Ivory", parse("#FFFFF0"))
					.put("Khaki", parse("#F0E68C"))
					.put("Lavender", parse("#E6E6FA"))
					.put("LavenderBlush", parse("#FFF0F5"))
					.put("LawnGreen", parse("#7CFC00"))
					.put("LemonChiffon", parse("#FFFACD"))
					.put("LightBlue", parse("#ADD8E6"))
					.put("LightCoral", parse("#F08080"))
					.put("LightCyan", parse("#E0FFFF"))
					.put("LightGoldenRodYellow", parse("#FAFAD2"))
					.put("LightGray", parse("#D3D3D3"))
					.put("LightGrey", parse("#D3D3D3"))
					.put("LightGreen", parse("#90EE90"))
					.put("LightPink", parse("#FFB6C1"))
					.put("LightSalmon", parse("#FFA07A"))
					.put("LightSeaGreen", parse("#20B2AA"))
					.put("LightSkyBlue", parse("#87CEFA"))
					.put("LightSlateGray", parse("#778899"))
					.put("LightSlateGrey", parse("#778899"))
					.put("LightSteelBlue", parse("#B0C4DE"))
					.put("LightYellow", parse("#FFFFE0"))
					.put("Lime", parse("#00FF00"))
					.put("LimeGreen", parse("#32CD32"))
					.put("Linen", parse("#FAF0E6"))
					.put("Magenta", parse("#FF00FF"))
					.put("Maroon", parse("#800000"))
					.put("MediumAquaMarine", parse("#66CDAA"))
					.put("MediumBlue", parse("#0000CD"))
					.put("MediumOrchid", parse("#BA55D3"))
					.put("MediumPurple", parse("#9370DB"))
					.put("MediumSeaGreen", parse("#3CB371"))
					.put("MediumSlateBlue", parse("#7B68EE"))
					.put("MediumSpringGreen", parse("#00FA9A"))
					.put("MediumTurquoise", parse("#48D1CC"))
					.put("MediumVioletRed", parse("#C71585"))
					.put("MidnightBlue", parse("#191970"))
					.put("MintCream", parse("#F5FFFA"))
					.put("MistyRose", parse("#FFE4E1"))
					.put("Moccasin", parse("#FFE4B5"))
					.put("NavajoWhite", parse("#FFDEAD"))
					.put("Navy", parse("#000080"))
					.put("OldLace", parse("#FDF5E6"))
					.put("Olive", parse("#808000"))
					.put("OliveDrab", parse("#6B8E23"))
					.put("Orange", parse("#FFA500"))
					.put("OrangeRed", parse("#FF4500"))
					.put("Orchid", parse("#DA70D6"))
					.put("PaleGoldenRod", parse("#EEE8AA"))
					.put("PaleGreen", parse("#98FB98"))
					.put("PaleTurquoise", parse("#AFEEEE"))
					.put("PaleVioletRed", parse("#DB7093"))
					.put("PapayaWhip", parse("#FFEFD5"))
					.put("PeachPuff", parse("#FFDAB9"))
					.put("Peru", parse("#CD853F"))
					.put("Pink", parse("#FFC0CB"))
					.put("Plum", parse("#DDA0DD"))
					.put("PowderBlue", parse("#B0E0E6"))
					.put("Purple", parse("#800080"))
					.put("RebeccaPurple", parse("#663399"))
					.put("Red", parse("#FF0000"))
					.put("RosyBrown", parse("#BC8F8F"))
					.put("RoyalBlue", parse("#4169E1"))
					.put("SaddleBrown", parse("#8B4513"))
					.put("Salmon", parse("#FA8072"))
					.put("SandyBrown", parse("#F4A460"))
					.put("SeaGreen", parse("#2E8B57"))
					.put("SeaShell", parse("#FFF5EE"))
					.put("Sienna", parse("#A0522D"))
					.put("Silver", parse("#C0C0C0"))
					.put("SkyBlue", parse("#87CEEB"))
					.put("SlateBlue", parse("#6A5ACD"))
					.put("SlateGray", parse("#708090"))
					.put("SlateGrey", parse("#708090"))
					.put("Snow", parse("#FFFAFA"))
					.put("SpringGreen", parse("#00FF7F"))
					.put("SteelBlue", parse("#4682B4"))
					.put("Tan", parse("#D2B48C"))
					.put("Teal", parse("#008080"))
					.put("Thistle", parse("#D8BFD8"))
					.put("Tomato", parse("#FF6347"))
					.put("Turquoise", parse("#40E0D0"))
					.put("Violet", parse("#EE82EE"))
					.put("Wheat", parse("#F5DEB3"))
					.put("White", parse("#FFFFFF"))
					.put("WhiteSmoke", parse("#F5F5F5"))
					.put("Yellow", parse("#FFFF00"))
					.put("YellowGreen", parse("#9ACD32"))
					.unmodifiable();
