class Dashing.Timeline extends Dashing.Widget
  ...
  renderTimeline: (events) ->
    ...
    TimeKnots.draw(".timeline", events, {horizontalLayout: false, color: "#222222", fontSize: @get('fontsize'), height: @get('height'), width: @get('width'), showLabels: true, labelFormat:"%H:%M"});