...
export class ViewService {
    ...
    public readCss(viewId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get(`${this.basePath}/views/${encodeURIComponent(String(viewId))}/css`,
            {
    ...
    public readHtml(viewId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get(`${this.basePath}/views/${encodeURIComponent(String(viewId))}/html`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public readJavascript(viewId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get(`${this.basePath}/views/${encodeURIComponent(String(viewId))}/js`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
