...
export class EventSourceService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public readInstanceUsage(id: string, observe?: 'body', reportProgress?: boolean): Observable<Array<DashboardInfo>>;
    public readInstanceUsage(id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<DashboardInfo>>>;
    public readInstanceUsage(id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<DashboardInfo>>>;
    public readInstanceUsage(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<DashboardInfo>>(`${this.basePath}/event-source/instances/${encodeURIComponent(String(id))}/usage`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
